...
const UpdateProduct = ({ params }) => {
  ...
  const getProductDetail = (field) => {
    ...
    if (
      product.detailedSpecification &&
      product.detailedSpecification.length > 0
    ) {
          ...
          <div className=" w-4/4  p-4 ml-6 mr-6 mb-10 overflow-y-auto">
            ...
            <div className="flex">
              ...
              <input
                ...
                value="Laptop"
                name="productType"
                checked={product.productType === "Laptop" ? true : false}
                type="radio"
                className="form-radio text-blue-500 mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
                Laptop
              </h2>
              <input
                onChange={handleChange}
                value="PC"
                name="productType"
                checked={product.productType === "PC" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
            ...
            <div className="flex">
              <h2 className="text-base text-black mb-1 mt-4 mr-4">
                Linh kiện:
              </h2>
              ...
              <input
                ...
                value="Màn hình"
                name="productType"
                checked={product.productType === "Màn hình" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="Ổ cứng"
                name="productType"
                checked={product.productType === "Ổ cứng" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="Chip"
                name="productType"
                checked={product.productType === "Chip" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              ...
              <input
                ...
                value="Tản nhiệt"
                name="productType"
                checked={product.productType === "Tản nhiệt" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="Mainboard"
                name="productType"
                checked={product.productType === "Mainboard" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="RAM"
                name="productType"
                checked={product.productType === "RAM" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
            ...
            <div className="flex">
              ...
              <input
                ...
                value="Chuột"
                name="productType"
                checked={product.productType === "Chuột" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="Bàn phím"
                name="productType"
                checked={product.productType === "Bàn phím" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
              ...
              <input
                ...
                value="Ghế gaming"
                name="productType"
                checked={product.productType === "Ghế gaming" ? true : false}
                type="radio"
                className="form-radio text-blue-500  mt-3 mr-2"
              />
              <h2 className="text-base text-black mb-1 mt-4 mr-2 pr-6">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "PC" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
                <div className="flex">
                  ...
                  <select
                    name="mau"
                    value={pcDetail.mau || "Đỏ"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="CPU"
                    value={pcDetail.CPU || "Intel Core i3"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="luuTru"
                    value={pcDetail.luuTru || "256GB SSD"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="heDieuHanh"
                    value={pcDetail.heDieuHanh || "Windows 10 Home"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="chip"
                    value={pcDetail.chip || "NVIDIA GeForce GTX 1650"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    <option value="Integrated Graphics">
                      Integrated Graphics
                    </option>
                    <option value="NVIDIA GeForce GTX 1650">
                      NVIDIA GeForce GTX 1650
                    </option>
                    <option value="NVIDIA GeForce GTX 1660 Ti">
                    ...
                    <option value="NVIDIA GeForce RTX 3080">
                      NVIDIA GeForce RTX 3080
                    </option>
                    <option value="AMD Radeon RX 5500M">
                      AMD Radeon RX 5500M
                    </option>
                    <option value="AMD Radeon RX 5600M">
                      AMD Radeon RX 5600M
                    </option>
                    <option value="AMD Radeon RX 5700M">
                      AMD Radeon RX 5700M
                    </option>
                    <option value="AMD Radeon RX 6700M">
                      AMD Radeon RX 6700M
                    </option>
                    <option value="AMD Radeon RX 6800M">
                      AMD Radeon RX 6800M
                    </option>
                  </select>
                </div>
                ...
                <div className="flex">
                  ...
                  <select
                    name="soCongLuuTruToiDa"
                    value={pcDetail.soCongLuuTruToiDa || "1 x M.2 NVMe"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
              ...
              <div className="flex-col ml-20">
                <div className="flex">
                  ...
                  <select
                    name="congXuatHinh"
                    value={pcDetail.congXuatHinh || "HDMI"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="khePCIPCIe"
                    value={pcDetail.khePCIPCIe || "PCI x4"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="congKetNoi"
                    value={pcDetail.congKetNoi || "USB 3.0"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    name="ketNoiKhongDay"
                    value={pcDetail.ketNoiKhongDay || "Bluetooth"}
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    <option value="Bluetooth">Bluetooth</option>
                    <option value="Wi-Fi">Wi-Fi</option>
                    <option value="Bluetooth và Wi-Fi">
                      Bluetooth và Wi-Fi
                    </option>
                    {/* Add more options here */}
                  </select>
                ...
                <div className="flex">
                  ...
                  <select
                    value={pcDetail.dauDocThe || "SD Card Reader"}
                    name="dauDocThe"
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    <option value="SD Card Reader">SD Card Reader</option>
                    <option value="MicroSD Card Reader">
                      MicroSD Card Reader
                    </option>
                    ...
                    <option value="Memory Stick Card Reader">
                      Memory Stick Card Reader
                    </option>
                    <option value="CompactFlash Card Reader">
                ...
                <div className="flex">
                  ...
                  <select
                    value={pcDetail.khoiLuong || "Dưới 1 kg"}
                    name="khoiLuong"
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    value={pcDetail.kichThuoc || "Dưới 14 inch"}
                    name="kichThuoc"
                    onChange={handlePCChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    ...
                    <option value="Trên 17 inch">Trên 17 inch</option>{" "}
                    {/* Add more options here */}
                  </select>
                </div>
              </div>
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Laptop" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    <option value="4K UHD (3840 x 2160)">
                      {"4K UHD (3840 x 2160)"}
                    </option>
                  </select>
                </div>
                ...
                <div className="flex">
                  ...
                  <select
                    value={laptopDetail.luuTruToiDa}
                    name="soCongLuuTruToiDa"
                    onChange={handleLaptopChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
              ...
              <div className="flex-col ml-20">
                <div className="flex">
                  ...
                  <select
                    value={laptopDetail.congXuatHinh}
                    name="congXuatHinh"
                    onChange={handleLaptopChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                ...
                <div className="flex">
                  ...
                  <select
                    value={laptopDetail.banPhim}
                    name="banPhim"
                    onChange={handleLaptopChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    <option value="Chiclet Keyboard">Chiclet Keyboard</option>
                    <option value="Backlit Chiclet Keyboard">
                ...
                <div className="flex">
                  ...
                  <select
                    name="ketNoiKhongDay"
                    value={laptopDetail.ketNoiKhongDay}
                    onChange={handleLaptopChange}
                    className="ml-auto ml-2 border border-gray-300 rounded-md shadow-sm p-2 text-black mt-4 pl-20 pr-20"
                  >
                    <option value="Bluetooth">Bluetooth</option>
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Màn hình" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Ổ cứng" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Chip" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Tản nhiệt" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Mainboard" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "RAM" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Chuột" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    <option value="LED đa dạng">LED đa dạng</option>{" "}
                  </select>
                </div>
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    <option value="Cảm biến quang học + Laser">
                      Cảm biến quang học + Laser
                    </option>
                    <option value="Cảm biến quang học đa chiều">
                      Cảm biến quang học đa chiều
                    </option>
                    <option value="Cảm biến cảm ứng">Cảm biến cảm ứng</option>{" "}
                  </select>
                </div>
                ...
                <div className="flex">
                  ...
                  <select
                    value={mouseDetail.thoiGianPhanHoi}
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Bàn phím" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
            ...
            <div
              className="flex "
              style={{
                display: product.productType === "Ghế gaming" ? "flex" : "none",
              }}
            >
              {/* CỘT THỨ 1 */}
              <div className="flex-col">
