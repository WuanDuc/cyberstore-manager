...
export default function SideBar() {
  return (
    <div className=" h-full overflow-y-auto">
      ...
      >
        <Sidebar.Logo href="#" img="/images/logo.ico" imgAlt="Flowbite logo">
          Cyber Store
        </Sidebar.Logo>
        <Sidebar.Items>
          <Sidebar.ItemGroup>
...
const customSideBarTheme: CustomFlowbiteTheme["sidebar"] = {
  root: {
    ...
    inner:
      "h-full overflow-y-auto overflow-x-hidden static rounded min-h-screen bg-gradient-to-b from-black to-indigo-950",
  },
  collapse: {
    button:
